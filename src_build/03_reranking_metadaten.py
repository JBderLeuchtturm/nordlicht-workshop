...
#   <div style="color:#7E93AC;font-size:12.5px;margin-top:12px">Workshop RAG Advanced · WDSKI23A · DHBW Mannheim &nbsp;·&nbsp; ca. 25 min · Übungen 3 + 4</div>
# </div>
#
...
#
# > Dauer ca. 25 Minuten · Übungen 3 und 4 sind von euch zu lösen (`# TODO`).
...
# encodiert, also schnell und vorberechenbar. Die Vektoren "sehen" einander aber nie.
#
...
# %% [markdown]
# ## 2 · Übung 3: Reranking implementieren
#
...
#
# Die Pipeline antwortet **"maximal zwei Tage"**, und zwar aus der **archivierten Regelung
...
# %% [markdown]
# ## 5 · Übung 4: Metadaten ernst nehmen
#
